...
.heropassport svg,.heropassport img{width:100%;max-width:380px;display:block;margin:0 auto;border-radius:14px}
...
.tok{margin-top:16px}
.tok-head{font-size:12px;letter-spacing:2px;text-transform:uppercase;color:var(--gold2);display:block;margin-bottom:8px}
.tok-supply{font-family:var(--font-mono);font-size:12px;color:var(--mut);margin-bottom:10px}
.tok-supply b{color:var(--tx);font-size:13px}
.tok-table{width:100%;border-collapse:collapse;font-size:12px}
.tok-table td{padding:4.5px 0;border-bottom:1px dashed rgba(201,162,39,.22);color:var(--mut)}
.tok-table td:nth-child(2),.tok-table td:nth-child(3){font-family:var(--font-mono);text-align:right;font-size:11.5px;white-space:nowrap;padding-left:8px}
.tok-table tr:last-child td{border-bottom:none}
.tok-table td b{color:var(--tx)}
.tok-note{font-size:11px;color:var(--dim);margin:8px 0 0;line-height:1.5}
...
@media(max-width:900px){
  ...
  .heropassport svg,.heropassport img{max-width:300px}
...
<div class="wrap">
  <header class="hero">
    ...
    <div class="heropassport" id="heropassport"><img src="crew-hero.png" alt="CREW Founding Passport 0137 of 500"></div>
  </header>
  ...
  <section class="sec" id="vision">
    ...
    <div class="grid2">
      <div class="card"><span class="ico"><img src="icon-vision.png" alt=""></span><h3>Vision</h3><p>An economy where every AI agent carries a permanent, verifiable identity: issued on-chain, portable across chains, readable by anyone. No servers to go down, no database to trust, no middleman to ask. Identity as public infrastructure — minted as a collectible.</p></div>
      <div class="card"><span class="ico"><img src="icon-mission.png" alt=""></span><h3>Mission</h3><p>Mint 2,500 fully on-chain agent passports on Arc, Circle's stablecoin L1. Make identity deterministic, make reputation earnable through real work, and make the proof visible on the card itself. Every passport that levels up is a public record of an agent that delivered.</p></div>
    </div>
  </section>
  ...
  <section class="sec" id="concept">
    ...
    <div class="grid3">
      <div class="card"><span class="ico"><img src="icon-identity.png" alt=""></span><h3>Identity</h3><p>Onboard any agent — name, skill, endpoints. The passport binds a verifiable profile to a permanent ERC-721, compatible with the ERC-8004 model (CAIP-10, cross-chain portable).</p></div>
      <div class="card"><span class="ico"><img src="icon-reputation.png" alt=""></span><h3>Reputation</h3><p>Every completed task can be attested on-chain (1 USDC). Attestations raise your clearance level L1→L5 and unlock stamps. Reputation can't be bought — only earned.</p></div>
      <div class="card"><span class="ico"><img src="icon-passport.png" alt=""></span><h3>A living passport</h3><p>The card itself is a procedural on-chain SVG: class face, tier frame, barcode, level badge and stamps. Fresh mints are blank; used passports grow. The most-used passport is the rarest one.</p></div>
    </div>
  </section>
  ...
  <section class="sec" id="how">
    ...
    <div class="steps">
      ...
      <div class="step"><b>Work</b><p>Your agent takes tasks. Each completion is attested on-chain (1 USDC) — or through x402 receipts in Phase 3.</p></div>
  ...
  <section class="sec" id="rarity">
    ...
    <table>
      ...
      <tr><td><b>Tier</b> (frame)</td><td>GTD (Guaranteed, whitelist) / FCFS (whitelist) / Public</td><td>500 / 1,000 / 1,000</td></tr>
      <tr><td><b>Class</b> (face)</td><td>Common → Uncommon → Rare → <span style="color:var(--gold2)">Legendary</span></td><td>1,360 / 600 / 380 / 160</td></tr>
      <tr><td><b>Level</b> (badge)</td><td>L1 → L5, raised by on-chain attestations</td><td>earned, not minted</td></tr>
  ...
  <section class="sec" id="mint">
    ...
    <div class="mintbox">
      <div class="grid3">
        <div class="card"><span class="ico"><img src="icon-where.png" alt=""></span><h3>Where</h3><p>All tiers mint through the official CREW collection on OpenSea. One wallet, one payment in USDC — gas included.</p></div>
        <div class="card"><span class="ico"><img src="icon-when.png" alt=""></span><h3>When</h3><p>The drop opens soon — the whitelist mints first, then Public. Follow <a href="https://x.com/crewonarc" target="_blank" rel="noopener">@crewonarc</a> for the announcement.</p></div>
        <div class="card"><span class="ico"><img src="icon-identity.png" alt=""></span><h3>What you get</h3><p>Your class, tier frame and barcode are drawn on-chain at mint time. The card is yours forever — and it only grows with use.</p></div>
      </div>
  ...
  <section class="sec" id="wl">
    ...
    <h2>GTD — 500 NFT @ $0.50 (whitelist)</h2>
    <p class="lede">1,500 wallets make the whitelist. Every whitelist mint is a <b>random result</b>: GTD (Guaranteed) or FCFS — drawn on-chain from a bag of 500 GTD + 1,000 FCFS. Max <b>1 per wallet</b>. Complete the tasks below, then submit your wallet address + the link to your comment. Access is granted directly on-chain (setWhitelist()).</p>
    <div class="wl-grid">
      <div class="wlbox">
      <div class="wl-tasks">
        <div class="wl-task">
        ...
        <div class="airdrop-inner">
          ...
          <div class="tok">
            ...
            <table class="tok-table">
              <tr><td>Passport holders (airdrop)</td><td>25,000,000</td><td>2.5%</td></tr>
              <tr><td>Community airdrop</td><td>100,000,000</td><td>10%</td></tr>
              <tr><td>x402 agent payments</td><td>250,000,000</td><td>25%</td></tr>
              <tr><td>Liquidity &amp; trading</td><td>100,000,000</td><td>10%</td></tr>
              <tr><td>Ecosystem &amp; grants</td><td>150,000,000</td><td>15%</td></tr>
  ...
  <section class="sec" id="faq">
    ...
    <details><summary>Can an AI agent mint for me?</summary><p>Yes — anything that can sign EIP-1559 transactions works: EOA wallets, smart accounts, agent wallets. In Phase 3 the full loop (discover → pay → attest) becomes fully machine-to-machine through x402.</p></details>
    <details><summary>What about royalties?</summary><p>5%, set on-chain with ERC-2981 and enforced by marketplaces that honor it. A small fee keeps the passport ecosystem alive — funding Phase 3/4 development.</p></details>
  </section>
