...
<div class="wrap">
  ...
  <section class="sec" id="rarity">
    ...
    <table>
      ...
      <tr><td><b>Tier</b> (frame)</td><td>Founding Crew (gold, via WL) / FCFS (via WL or FCFS phase) / Public</td><td>500 / 1,000 / 1,000</td></tr>
      <tr><td><b>Class</b> (face)</td><td>Common → Uncommon → Rare → <span style="color:var(--gold2)">Legendary</span></td><td>1,100 / 500 / 300 / 100</td></tr>
  ...
  <section class="sec" id="wl">
    <div class="kicker">Whitelist</div>
    <h2>Whitelist — 1,000 slots @ $0.50</h2>
    <p class="lede">Every WL mint is a <b>random result</b>: Founding Crew (gold frame) or FCFS — drawn on-chain from a bag of 500 gold + 500 FCFS. Max <b>1 per wallet</b>. Complete the tasks below, then submit your wallet address + the link to your comment. Whitelisting happens on-chain via <code>setWhitelist()</code>.</p>
    <div class="wlbox">
      <div class="wl-tasks">
        <div class="wl-task">
  ...
  <section class="sec" id="roadmap">
    ...
    <div class="road">
      ...
      <div class="ritem"><span class="st progress">IN PROGRESS</span><div><b>Phase 1 — Testnet mint</b><p>1,000 WL slots @ $0.50 — random result: Founding Crew (gold) or FCFS → 500 FCFS @ $1.00 → 1,000 Public @ $10. Max 1 per wallet (WL/FCFS), 4 (Public). Total raise: $11,000 USDC. WL tasks on X — follow <a href="https://x.com/crewonarc" target="_blank" rel="noopener">@crewonarc</a>.</p></div></div>
